 ...
 * 维表join demo
 */
public class FlinkSqlDimJoinDemo {
    ...
    public static final String CSV_TABLE_SOURCE_DDL = ""
        ...
        + " 'connector.path' = 'F:\\UserBehavior.csv',-- 目录 \n"
    ...
    public static final String MYSQL_TABLE_DIM_DDL = ""
        ...
        + " 'connector.url' = 'jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=UTF-8', -- jdbc的url\n"
    ...
    public static void main(String[] args) throws Exception {
        ...
        //注册csv文件数据源表
        tEnv.executeSql(CSV_TABLE_SOURCE_DDL);
        //注册mysql数据维表
        tEnv.executeSql(MYSQL_TABLE_DIM_DDL);
        //注册mysql数据结果表
        ...
        DataStream<Row> ds = tEnv.toRetractStream(group, Row.class)
        ...
        //数据输出到mysql
        tEnv.executeSql("insert into result_1 select * from join_view");
        //任务启动，这行必不可少！

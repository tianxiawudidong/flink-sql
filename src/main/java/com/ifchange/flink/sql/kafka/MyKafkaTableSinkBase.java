...
package com.ifchange.flink.sql.kafka;
 ...
 */
@Internal
public abstract class MyKafkaTableSinkBase implements UpsertStreamTableSink<Row> {
    ...
    protected MyKafkaTableSinkBase(
        TableSchema schema,
        String topic,
...
//    }
    ...
    @Override
    public MyKafkaTableSinkBase configure(String[] fieldNames, TypeInformation<?>[] fieldTypes) {
    ...
    public boolean equals(Object o) {
        ...
        final MyKafkaTableSinkBase that = (MyKafkaTableSinkBase) o;
